...
class WithdrawStatementWidget extends StatefulWidget {
  const WithdrawStatementWidget({
    super.key,
  });

  @override
  State<WithdrawStatementWidget> createState() =>
      _WithdrawStatementWidgetState();
}

class _WithdrawStatementWidgetState extends State<WithdrawStatementWidget> {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<UserCubit, UserModel>(builder: (context, user) {
      return FutureBuilder<Map<String, dynamic>>(
        future: HttpRequests.withdrawStatementRequest(
