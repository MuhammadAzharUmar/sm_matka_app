...
class StarlineGameMainWidget extends StatelessWidget {
  const StarlineGameMainWidget({super.key, required this.snapshot});
      ...
      child: Column(
        children: [
          ...
          Card(
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemCount: snapshot.data!["data"]["starline_rates"].length,
                        ...
                        children: [
                          Text(
                            ConvertToTitleCase.convertToTitleCase(
                                snapshot.data!["data"]["starline_rates"][index]
                                    ["name"]),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(snapshot.data!["data"]["starline_rates"]
                                  [index]["cost_amount"]),
                            ],
                          ),
                          Column(
          ...
          ListView.builder(
            shrinkWrap: true,
            physics: const NeverScrollableScrollPhysics(),
            itemCount: snapshot.data!["data"]["starline_game"].length,
            itemBuilder: (context, index) {
              bool isMarketOpen =
                  (snapshot.data!["data"]["starline_game"][index]["play"]);
              return InkWell(
                onTap: () {
                  if (isMarketOpen) {
                    //move to next page
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => MainGameScreen(
                          ...
                          title: snapshot.data!["data"]["starline_game"][index]
                              ["name"],
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                snapshot.data!["data"]["starline_game"][index]
                                    ["name"],
                                style: kSmallTextStyle.copyWith(
                                  color: kBlue1Color,
                                  fontWeight: FontWeight.w700,
                              ...
                              Text(
                                isMarketOpen ? "Merket Open" : "Market Closed",
                                style: kSmallCaptionTextStyle.copyWith(
                                    color: kBlue1Color),
                              )
                            ],
