...
class GaliDesawarGamesFieldScreen extends StatefulWidget {
  const GaliDesawarGamesFieldScreen(
      {super.key, required this.title, required this.marketDetails});
  final String title;
  final Map<String, dynamic> marketDetails;
  @override
  State<GaliDesawarGamesFieldScreen> createState() =>
      _GaliDesawarGamesFieldScreenState();
}

class _GaliDesawarGamesFieldScreenState
    extends State<GaliDesawarGamesFieldScreen> {
  ...
  List<GaliDesawarGameBid> gameBids = [];
  @override
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          ...
                          child: BidTileWidget.galiDesawarbidTileWidget(
                            bid: gameBids[index],
                            onpress: () {
                              setState(() {
                    ...
                    onPressed: () async {
                      ...
                      for (var bid in gameBids) {
                        final map = {
                          ...
                          "left_digit": bid.leftDigit.toString(),
                          "right_digit": bid.rightDigit.toString(),
                        };
                        list.add(map);
                      }
                      if (list.isNotEmpty) {
